<div>
    ...
    <div class="flex justify-center">
        <button type="button" onclick="location.href='{{ route('admin.stylist.index') }}'" class="text-gray bg-gray-300 border-0 mt-8 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
    </div>
