        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 border border-green-400">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-col p-6">
                    ...
                    <button type="button" onclick="location.href='{{ route('user.reservation.index') }}'" class="text-gray bg-blue-300 border-0 w-64 py-2 px-8 mx-auto focus:outline-none hover:bg-blue-600 rounded">予約する</button>
