                                ...
                                <form method="post" action="{{ route('admin.stylist.store') }}">
                                    ...
                                    <div class="-m-2">
                                        ...
                                        <div class="p-2 w-full flex justify-end mt-4">
                                            <button type="submit" class="text-gray bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button>
                                            <button type="button" location.href='{{ route('admin.stylist.index') }}'" class="text-gray bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
