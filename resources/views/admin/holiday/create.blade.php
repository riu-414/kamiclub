                        ...
                        <form method="post" action="{{ route('admin.holiday.store') }}">
                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                        <label for="holiday">日付</label>
                                        <input type="date" id="holiday" name="holiday" value="{{ old('holiday') }}" class="w-full rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    </div>
                                ...
                                <div class="p-2 w-full flex justify-center mt-4">
                                    ...
                                    <button type="button" onclick="location.href='{{ route('admin.holiday.index') }}'" class="text-gray bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                </div>
                            </div>
                        </form>
                    </div>
