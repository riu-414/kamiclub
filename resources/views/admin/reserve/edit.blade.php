                        ...
                        <form method="post" action="{{ route('admin.reserve.update',  ['reserve' => $reserve->id]) }}">
                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-full flex justify-center mt-4">
                                    ...
                                    <button type="button" onclick="location.href='{{ route('admin.reserve.show', ['reserve' => $reserve->id]) }}'" class="text-gray bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                </div>
                            </div>
                        </form>
                    </div>
