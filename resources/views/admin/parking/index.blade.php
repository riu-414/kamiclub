                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <button onclick="location.href='{{ route('admin.parking.index', ['parking' => $parking->id]) }}'" class="text-gray bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded">編集する</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
